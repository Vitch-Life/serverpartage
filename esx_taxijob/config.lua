...
Config.NPCJobEarnings             = {min = 75, max = 125}
...
Config.Zones = {
	...
	VehicleSpawner = {
		Pos   = {x = 888.5006, y = -170.9672, z = 77.1086},
	...
	VehicleSpawnPoint = {
		Pos     = {x = 896.3639, y = -153.2929, z = 76.2098},
	...
	VehicleDeleter = {
		Pos   = {x = 888.7044, y = -159.5363, z = 75.90},
	...
	TaxiActions = {
		Pos   = {x = 909.8406, y = -152.9932, z = 74.1682},
		Size  = {x = 1.0, y = 1.0, z = 1.0},
		Color = {r = 204, g = 204, b = 0},
		Type  = 20, Rotate = true
	}
