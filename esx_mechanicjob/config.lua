...
Config.Zones = {
	...
	MechanicActions = {
		Pos   = { x = 1017.0998535156, y = -2291.8056640625, z = 30.54778297949 },
	...
	Craft = {
		Pos   = { x = 1016.7729492188, y = -2309.2253417969, z = 30.509538650513 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 255, g = 255, b = 255 },
		Type  = 42
	},
	...
	VehicleSpawnPoint = {
		Pos   = { x = 988.19128417969, y = -2349.9924316406, z = 30.509557723999 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1
	},

	VehicleDeleter = {
		Pos   = { x = 996.44635009766, y = -2310.9326171875, z = 30.509674072266 },
